   ...
   <section class="content">
    <div class="container-fluid">
    	<div class="card card-info">
    		<div class="card-header">CONSOLIDATED REPORTS</div>
    		<div class="card-body">
...
@endsection
  <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var ctx = document.getElementById('myChart_pt');
            if (ctx) {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Drawing chart with Chart.js
            var ctx = document.getElementById('myChart_pa');
            if (ctx) {
                var myChart = new Chart(ctx, {
                    type: 'bar',
                    data: {
   ...
   <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Drawing chart with Chart.js
            var ctx = document.getElementById('myChart_pcombined').getContext('2d');
            var myChart = new Chart(ctx, {
                type: 'bar',
                data: {
