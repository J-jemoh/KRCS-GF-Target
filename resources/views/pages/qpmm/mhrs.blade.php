        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="#" class="text-white">MHRS REPORT</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
   ...
   <section class="content">
    <div class="container-fluid">
    	<div class="card card-info">
    		<div class="card-header">MHRS REPORTS</div>
    		<div class="card-body">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="card-body">
           <div style="width: 100%;">
                <canvas id="myChart_mhrs_pt"></canvas>
            </div>
        </div>
      </div>
        </div>
        ...
        <div class="card-body">
           <div style="width: 100%;">
                <canvas id="myChart_mhrs_pa"></canvas>
            </div>
        </div>
      </div>
        </div>
        ...
        <div class="card-body">
           <div style="width: 100%;">
                <canvas id="myChart_pcombined_mhrs" height="100"></canvas>
            </div>
        </div>
      </div>
        </div>
...
<script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var ctx = document.getElementById('myChart_mhrs_pt');
            if (ctx) {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Drawing chart with Chart.js
            var ctx = document.getElementById('myChart_mhrs_pa');
            if (ctx) {
                var myChart = new Chart(ctx, {
                    type: 'bar',
                    data: {
   ...
   <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Drawing chart with Chart.js
            var ctx = document.getElementById('myChart_pcombined_mhrs').getContext('2d');
            var myChart = new Chart(ctx, {
                type: 'bar',
                data: {
