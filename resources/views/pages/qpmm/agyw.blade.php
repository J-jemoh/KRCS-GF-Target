   ...
   <section class="content">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="card-body">
           <div style="width: 100%;">
                <canvas id="myChart_agyw_pt"></canvas>
            </div>
        </div>
      </div>
        </div>
        ...
        <div class="card-body">
           <div style="width: 100%;">
                <canvas id="myChart_agyw_pa"></canvas>
            </div>
        </div>
      </div>
        </div>
        ...
        <div class="card-body">
           <div style="width: 100%;">
                <canvas id="myChart_pcombined_agyw" height="100"></canvas>
            </div>
        </div>
      </div>
        </div>
...
@endsection
 <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var ctx = document.getElementById('myChart_agyw_pt');
            if (ctx) {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Drawing chart with Chart.js
            var ctx = document.getElementById('myChart_agyw_pa');
            if (ctx) {
                var myChart = new Chart(ctx, {
                    type: 'bar',
                    data: {
   ...
   <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Drawing chart with Chart.js
            var ctx = document.getElementById('myChart_pcombined_agyw').getContext('2d');
            var myChart = new Chart(ctx, {
                type: 'bar',
                data: {
