          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="{{route('admin.fsw.index')}}" class="text-white">Typology</a></li>
               <li class="breadcrumb-item active"><a href="#" class="text-white">PWID</a></li>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-4">
         ...
         <div class="col-4">
          <label>..</label>
          <a href="{{route('admin.pwid.consolidated',['month' => $month->month, 'year' => $month->year])}}" class="btn btn-info btn-block">Download/Export to CSV</a>
        </div>
        <br>
        <br>
       <!--  <div class="col-4">
          <a href="{{route('admin.pwid.consolidated')}}" class="btn btn-info btn-block">Download/Export to CSV</a>
        </div>
         <div class="col-4">
            ...
            <div class="row">
              <div class="col-sm-6">
                <table class="table table-bordered table-striped table-condensed">
                  ...
                  <tbody>
                      <tr>
                          <td>#of PWID reached with HIV prevention programs - defined package</td>
