        ...
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
            <li class="breadcrumb-item"><a href="#">Users</a></li>
              <li class="breadcrumb-item"><a href="{{ route('admin.users.role.index') }}">Roles</a></li>
...
<!-- Container -->
    ...
    <div class="card">
    	...
    	<h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="plus"></i></span></span>Add Role</h4>
    	</div>
    ...
    <div class="row">
        <div class="col-md-6">
            <section class="hk-sec-wrapper">
                <h5 class="hk-sec-title">Enter Role Details</h5>
                <form method="POST" action="{{route('admin.users.role.store')}}" role="form">
                    @csrf
