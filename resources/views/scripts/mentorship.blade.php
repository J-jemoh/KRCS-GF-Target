...
document.addEventListener("DOMContentLoaded", function() {
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){
        var data = {
            labels: {!! $gendercount->pluck('sex') !!},
            datasets: [{
                data: {!! $gendercount->pluck('count') !!},
                backgroundColor: [
                	 'rgba(0, 255, 255,0.5)',
                     'rgba(0, 71, 171, 0.8)',
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){
        var data = {
            labels: {!! $completeSessions->pluck('complete_session') !!},
            datasets: [{
                data: {!! $completeSessions->pluck('count') !!},
                backgroundColor: [
                    'rgba(0, 71, 171, 0.8)',
                    'rgba(0, 255, 255,0.5)',
        ...
        // Get the canvas element
        var ctx = document.getElementById('CsessionsPieChart').getContext('2d');
...
<!-- PEP WITHIN 72HR -->
    ...
    // Data for the pie chart
    document.addEventListener("DOMContentLoaded", function(){
        var labels = {!! $Countycount->pluck('counties') !!};
        var counts = {!! $Countycount->pluck('count') !!};
        ...
        // Get the canvas element
        var ctx = document.getElementById('CountybarChart').getContext('2d');
