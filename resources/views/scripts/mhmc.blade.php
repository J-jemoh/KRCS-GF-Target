...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var ctx = document.getElementById('agemPieChart').getContext('2d');
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){
        var data = {
            labels: {!! $gendermhmc->pluck('sex') !!},
            datasets: [{
                data: {!! $gendermhmc->pluck('count') !!},
                backgroundColor: [
                	 'rgba(0, 255, 255,0.5)',
                     'rgba(0, 71, 171, 0.8)',
        ...
        var ctx = document.getElementById('gendermPieChart').getContext('2d');
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function(){
        var data = {
            labels: {!! $completeSessionsmhmc->pluck('complete_sessions') !!},
            datasets: [{
                data: {!! $completeSessionsmhmc->pluck('count') !!},
                backgroundColor: [
                    'rgba(0, 71, 171, 0.8)',
                    'rgba(0, 255, 255,0.5)',
        ...
        // Get the canvas element
        var ctx = document.getElementById('CsessionmPieChart').getContext('2d');
...
<!-- PEP WITHIN 72HR -->
    ...
    // Data for the pie chart
    document.addEventListener("DOMContentLoaded", function(){
        var labels = {!! $Countycountmhmc->pluck('county') !!};
        var counts = {!! $Countycountmhmc->pluck('count') !!};
        ...
        // Get the canvas element
        var ctx = document.getElementById('countymPieChart').getContext('2d');
...
<!-- SR DISTRIBUTION -->
 <script>
    // Data for the pie chart
    document.addEventListener("DOMContentLoaded", function(){
        var labels = {!! $SRcountmhmc->pluck('implementing_partner') !!};
        var counts = {!! $SRcountmhmc->pluck('count') !!};
        ...
        // Get the canvas element
        var ctx = document.getElementById('SRdistributionChart').getContext('2d');
