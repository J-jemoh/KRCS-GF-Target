<!-- Modal -->
<div class="modal fade" id="status-{{$highlight->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
    	<form method="post" action="{{route('monthly.updateStatus',$highlight->id)}}">
    		@csrf
    		@method('PUT')
