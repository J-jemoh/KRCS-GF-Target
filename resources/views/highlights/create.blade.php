  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <div class="card">
        ...
        <div class="card-header"><b>New Regional Monthly Highlight</b>
        </div>
        <div class="card-body">
       <form method="post" action="{{route('monthly.store')}}">
          ...
          <div class="row">
          	<div class="col-12">
          		...
          		<textarea name="key_highlight" class="form-control" id="notes" rows="5" ></textarea>
          		</div>
          	</div>
          	<div class="col-12">
          		<div class="form-group">
          		<label for="exampleFormControlInput1">Key Actions </label>
          		<textarea name="key_action" class="form-control" id="notes1" rows="5" ></textarea>
          		</div>
          	</div>
          	<div class="col-12">
          		<div class="form-group">
          		<label for="exampleFormControlInput1">Support required from HQ </label>
          		<textarea name="hq_support" class="form-control" id="notes2" rows="5"></textarea>
          		</div>
          	</div>
          	<div class="col-12">
          		<div class="form-group">
          		<label for="exampleFormControlInput1">Plans for next month </label>
          		<textarea name="month_plan" class="form-control" id="notes3" rows="5"></textarea>
          		</div>
          	</div>
          	<div class="col-12">
          		<div class="form-group">
