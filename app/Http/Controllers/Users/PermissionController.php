...
class PermissionController extends Controller {
    ...
    public function index() {
        ...
        return view('auth.permissions.index')->with('permissions', $permissions);
    }
    ...
    public function create() {
        ...
        return view('auth.permissions.create')->with('roles', $roles);
    }
    ...
    public function destroy($id) {
        ...
        if ($permission->name == "Administer roles & permissions") {
            return redirect()->route('admin.users.permission.index')
                ->with('warning', 'Cannot delete this Permission!');
        }
